...
<div class="container-fluid">
    <div class="row mb-3">
        <div class="col-12 d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('parent.admit-cards.download-pdf', $admitCard) }}" class="btn btn-primary">Download PDF</a>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="mt-3 text-center">
                <a href="{{ route('parent.admit-cards.index') }}" class="btn btn-secondary">Back</a>
                <a href="{{ route('parent.admit-cards.download-pdf', $admitCard) }}" class="btn btn-primary">Download PDF</a>
            </div>
        </div>
    </div>
