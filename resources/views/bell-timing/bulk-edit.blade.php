...
<body>
    <div class="container mt-4 mb-5">
        ...
        <div class="alert alert-warning">
            ...
            Select the class/day schedules you want to edit. The next screen lets you pick which period to
            change and what to change it to -- nothing is updated from this page.
        </div>

        @if($groups->isEmpty())
            <div class="alert alert-info">No Bell Timing schedules exist yet.</div>
        @else
            <form action="{{ route('bell-timing.bulk-edit.target') }}" method="POST">
                @csrf
                <div class="card mb-3">
                ...
                <button type="submit" class="btn btn-warning btn-lg" id="nextBtn" disabled>
                    <i class="bi bi-arrow-right-circle"></i> Choose Period to Edit
                </button>
            </form>
        @endif
    </div>
