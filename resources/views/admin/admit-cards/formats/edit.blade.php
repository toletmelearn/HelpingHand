...
@section('title', 'Edit Admit Card Format')
        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header">
                    <h4>Edit Admit Card Format - {{ $admitCardFormat->name }}</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.admit-card-formats.update', $admitCardFormat) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" 
                                   id="name" name="name" value="{{ old('name', $admitCardFormat->name) }}" required>
                            @error('name')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('header_html') is-invalid @enderror" 
                                      id="header_html" name="header_html" rows="5">{{ old('header_html', $admitCardFormat->header_html) }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('body_html') is-invalid @enderror" 
                                      id="body_html" name="body_html" rows="10">{{ old('body_html', $admitCardFormat->body_html) }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('footer_html') is-invalid @enderror" 
                                      id="footer_html" name="footer_html" rows="5">{{ old('footer_html', $admitCardFormat->footer_html) }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('background_image') is-invalid @enderror" 
                                   id="background_image" name="background_image" value="{{ old('background_image', $admitCardFormat->background_image) }}">
                        ...
                        <div class="mb-3 form-check">
                            <input type="checkbox" class="form-check-input @error('is_active') is-invalid @enderror" 
                                   id="is_active" name="is_active" value="1" {{ old('is_active', $admitCardFormat->is_active) ? 'checked' : '' }}>
