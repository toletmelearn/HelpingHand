...
@section('title', 'Create Exam Paper Template')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4>Create Exam Paper Template</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.exam-paper-templates.store') }}" method="POST">
                        @csrf
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('header_content') is-invalid @enderror" 
                                              id="header_content" name="header_content" rows="3">{{ old('header_content') }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('instruction_block') is-invalid @enderror" 
                                              id="instruction_block" name="instruction_block" rows="4">{{ old('instruction_block') }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('footer_content') is-invalid @enderror" 
                                              id="footer_content" name="footer_content" rows="3">{{ old('footer_content') }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('template_content') is-invalid @enderror" 
                                      id="template_content" name="template_content" rows="10">{{ old('template_content') }}</textarea>
                            <div class="form-text">
