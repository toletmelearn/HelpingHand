        ...
        <div class="card-body">
            <form action="{{ route('admin.school-classes.store') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="class_order" class="form-label">Class Order *</label>
                            <input type="number" class="form-control @error('class_order') is-invalid @enderror"
                                   id="class_order" name="class_order" value="{{ old('class_order') }}" min="1" required>
                            @error('class_order')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select class="form-control @error('academic_session_id') is-invalid @enderror"
                                    id="academic_session_id" name="academic_session_id">
