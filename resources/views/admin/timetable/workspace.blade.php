                    ...
                    <div class="row">
                        @php
                            $setupLinks = [
                                ...
                                ['admin.teacher-subject-assignments.index', 'Teacher-Subject Assignment (incl. section-level Class Teacher)', 'fa-exchange-alt'],
                                ['admin.teacher-class-assignments.index', 'Class Teacher Assignment (whole class only, not used by Timetable)', 'fa-user-check'],
