...
<div class="container">
                    ...
                    <form action="{{ route('admin.syllabi.update', $syllabus) }}" method="POST">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control @error('subject') is-invalid @enderror" 
                                        ...
                                        @foreach($subjects as $subject)
                                            <option value="{{ $subject }}" {{ old('subject', $syllabus->subject) == $subject ? 'selected' : '' }}>
                                                {{ $subject }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control @error('class_name') is-invalid @enderror" 
                                        ...
                                        @foreach($classes as $class)
                                            <option value="{{ $class }}" {{ old('class_name', $syllabus->class_name) == $class ? 'selected' : '' }}>
                                                {{ $class }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control @error('section') is-invalid @enderror" 
                                        ...
                                        @foreach($sections as $section)
                                            <option value="{{ $section }}" {{ old('section', $syllabus->section) == $section ? 'selected' : '' }}>
                                                {{ $section }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('title') is-invalid @enderror" 
                                           id="title" name="title" value="{{ old('title', $syllabus->title) }}" maxlength="255" required>
                                    @error('title')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control @error('start_date') is-invalid @enderror" 
                                           id="start_date" name="start_date" value="{{ old('start_date', $syllabus->start_date) }}">
                                    @error('start_date')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('total_duration_hours') is-invalid @enderror" 
                                           id="total_duration_hours" name="total_duration_hours" value="{{ old('total_duration_hours', $syllabus->total_duration_hours) }}" step="0.01" min="0">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" 
                                              id="description" name="description" rows="4">{{ old('description', $syllabus->description) }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control @error('end_date') is-invalid @enderror" 
                                           id="end_date" name="end_date" value="{{ old('end_date', $syllabus->end_date) }}">
                                    @error('end_date')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('academic_session') is-invalid @enderror" 
                                           id="academic_session" name="academic_session" value="{{ old('academic_session', $syllabus->academic_session) }}" placeholder="e.g. 2024-2025">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control @error('status') is-invalid @enderror" 
                                        ...
                                        <option value="active" {{ old('status', $syllabus->status) == 'active' ? 'selected' : '' }}>Active</option>
                                        <option value="draft" {{ old('status', $syllabus->status) == 'draft' ? 'selected' : '' }}>Draft</option>
                                        <option value="archived" {{ old('status', $syllabus->status) == 'archived' ? 'selected' : '' }}>Archived</option>
                                    </select>
                                    @error('status')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <div id="chapters-container">
                                @if(old('chapters') ?? $syllabus->chapters)
                                    @php
                                        $chapters = old('chapters') ?? $syllabus->chapters;
                                    @endphp
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('learning_objectives') is-invalid @enderror" 
                                      id="learning_objectives" name="learning_objectives" rows="3">{{ old('learning_objectives', json_encode($syllabus->learning_objectives, true)) }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('assessment_criteria') is-invalid @enderror" 
                                      id="assessment_criteria" name="assessment_criteria" rows="3">{{ old('assessment_criteria', json_encode($syllabus->assessment_criteria, true)) }}</textarea>
    ...
    <script>
        let chapterIndex = <?php echo old('chapters') ? count(old('chapters')) : ($syllabus->chapters ? count($syllabus->chapters) : 0); ?>;
