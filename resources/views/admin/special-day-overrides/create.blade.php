...
@section('title', 'Add Special Day Override')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Add New Special Day Override</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.special-day-overrides.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control @error('override_date') is-invalid @enderror" id="override_date" name="override_date" value="{{ old('override_date') }}" required>
                                    @error('override_date')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('type') is-invalid @enderror" id="type" name="type" required>
                                        ...
                                        <option value="exam_day" {{ old('type') == 'exam_day' ? 'selected' : '' }}>Exam Day</option>
                                        <option value="half_day" {{ old('type') == 'half_day' ? 'selected' : '' }}>Half Day</option>
                                        <option value="event_day" {{ old('type') == 'event_day' ? 'selected' : '' }}>Event Day</option>
                                        <option value="emergency_closure" {{ old('type') == 'emergency_closure' ? 'selected' : '' }}>Emergency Closure</option>
                                    </select>
                                    @error('type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('bell_schedule_id') is-invalid @enderror" id="bell_schedule_id" name="bell_schedule_id">
                                        ...
                                        <option value="{{ $schedule->id }}" {{ old('bell_schedule_id') == $schedule->id ? 'selected' : '' }}>
