...
<div class="container">
    <div class="row">
        <div class="col-12">
            <h1>Lesson Plan Management</h1>
            <p class="mb-4">Manage all lesson plans across the school</p>
            
            <div class="card mb-4">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">All Lesson Plans</h5>
                        <a href="{{ route('admin.lesson-plans.create') }}" class="btn btn-primary">
                ...
                <div class="card-body">
                    @if($lessonPlans->isEmpty())
                        <div class="text-center py-5">
                            ...
                            <p class="mt-3 text-muted">No lesson plans found. Create your first lesson plan to get started.</p>
                        </div>
                    @else
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group btn-group-sm" role="group">
                                                    ...
                                                    <a href="{{ route('admin.lesson-plans.edit', $plan) }}" 
                                                       class="btn btn-outline-primary" 
                                                       title="Edit">
                                                        <i class="bi bi-pencil"></i>
                                                    </a>
                                                    <a href="{{ route('admin.lesson-plans.destroy', $plan) }}" 
