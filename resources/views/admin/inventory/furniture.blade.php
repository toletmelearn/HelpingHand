        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <form method="GET" action="{{ route('inventory.furniture') }}">
                                <div class="row">
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <a href="{{ route('inventory.furniture') }}" class="btn btn-secondary">Reset</a>
                                    </div>
                                </div>
                            </form>
                        </div>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                @forelse($assets as $asset)
                                    @if($asset->category && $asset->category->type == 'furniture')
                                    <tr>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="8" class="text-center">No furniture assets found</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
...
<!-- Issue Asset Modal -->
<div class="modal fade" id="issueAssetModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="issueAssetForm" method="POST">
                @csrf
                @method('PUT')
...
$(document).ready(function() {
    // Handle issue asset button clicks
    $(document).on('click', 'button[data-action="issue"]', function() {
        var assetId = $(this).data('asset-id');
        document.getElementById('issueAssetForm').action = '/admin/inventory/assets/' + assetId + '/issue';
    ...
    // Handle return asset button clicks
    $(document).on('click', 'button[data-action="return"]', function() {
        var assetId = $(this).data('asset-id');
        document.getElementById('returnAssetForm').action = '/admin/inventory/assets/' + assetId + '/return';
