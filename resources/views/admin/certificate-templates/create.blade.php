    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Create Certificate Template</h4>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">New Certificate Template</h4>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.certificate-templates.store') }}">
                        @csrf
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="type" id="type" class="form-control @error('type') is-invalid @enderror" required>
                                        ...
                                        <option value="tc" {{ old('type') == 'tc' ? 'selected' : '' }}>Transfer Certificate (TC)</option>
                                        <option value="bonafide" {{ old('type') == 'bonafide' ? 'selected' : '' }}>Bonafide Certificate</option>
                                        <option value="character" {{ old('type') == 'character' ? 'selected' : '' }}>Character Certificate</option>
                                        <option value="experience" {{ old('type') == 'experience' ? 'selected' : '' }}>Experience Certificate</option>
                                    </select>
                                    @error('type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <div class="border p-3 rounded bg-light">
                                ...
                                <textarea name="template_variables[]" id="template_variables" class="form-control mt-2" rows="5" placeholder="Enter template variables, one per line&#10;recipient.name&#10;recipient.id&#10;certificate.serial_number&#10;certificate.type&#10;date" required>{{ implode("\n", old('template_variables', [])) }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="border p-3 rounded bg-light">
                                ...
                                <div class="mt-2">
                                    ...
                                    <textarea name="template_content" id="template_content" class="form-control @error('template_content') is-invalid @enderror" rows="15" required>{{ old('template_content') }}</textarea>
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="{{ route('admin.certificate-templates.index') }}" class="btn btn-secondary">Cancel</a>
