...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <h1 class="h3 mb-4">
                <i class="bi bi-hdd-network"></i> Add Biometric Device
            </h1>
            
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="card-title">New Biometric Device</h5>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="device_type" id="device_type" class="form-select @error('device_type') is-invalid @enderror">
                                        ...
                                        <option value="essl" {{ old('device_type') == 'essl' ? 'selected' : '' }}>ESSL</option>
                                        <option value="mantra" {{ old('device_type') == 'mantra' ? 'selected' : '' }}>Mantra</option>
                                        <option value="generic_rest" {{ old('device_type') == 'generic_rest' ? 'selected' : '' }}>Generic REST API</option>
                                    </select>
                                    @error('device_type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
