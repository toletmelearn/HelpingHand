...
<div class="container-fluid py-4">
    ...
    <div class="mb-4">
        ...
        <h1 class="h3 d-inline-block align-middle mb-0 mt-2 mt-md-0">Issue Outbound Gate Pass</h1>
    </div>
    ...
    <div class="card border-0 shadow-sm bg-white">
        <div class="card-body">
            <form action="{{ route('admin.front-office.gate-passes.store') }}" method="POST">
                @csrf
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="pass_type" id="pass_type" class="form-select" required>
                            <option value="student" {{ old('pass_type') === 'student' || is_null(old('pass_type')) ? 'selected' : '' }}>Student Exit Pass</option>
                            <option value="staff" {{ old('pass_type') === 'staff' ? 'selected' : '' }}>Staff Exit Pass</option>
                            <option value="visitor" {{ old('pass_type') === 'visitor' ? 'selected' : '' }}>Visitor/Visitor Vehicle Exit Pass</option>
                            <option value="vehicle" {{ old('pass_type') === 'vehicle' ? 'selected' : '' }}>General School Vehicle Pass</option>
                        </select>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="holder_name" id="holder_name" class="form-control" placeholder="Enter recipient full name" value="{{ old('holder_name') }}" required>
                    </div>

                    <!-- Student Select (Shown if student type) -->
                    <div class="col-md-6 {{ old('pass_type', 'student') === 'student' ? '' : 'd-none' }}" id="student_select_container">
                    ...
                    <div class="col-md-6 {{ old('pass_type') === 'staff' ? '' : 'd-none' }}" id="staff_select_container">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="vehicle_no" class="form-control" placeholder="e.g. MH-12-XY-9999" value="{{ old('vehicle_no') }}">
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="exit_gate" class="form-select" required>
                            <option value="Gate 1" {{ old('exit_gate') === 'Gate 1' ? 'selected' : '' }}>Gate 1 (Primary Wing)</option>
                            <option value="Gate 2" {{ old('exit_gate') === 'Gate 2' ? 'selected' : '' }}>Gate 2 (Senior Wing)</option>
                            <option value="Main Gate" {{ old('exit_gate') === 'Main Gate' || is_null(old('exit_gate')) ? 'selected' : '' }}>Main Gate</option>
                            <option value="Hostel Gate" {{ old('exit_gate') === 'Hostel Gate' ? 'selected' : '' }}>Hostel Gate</option>
                        </select>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="time" name="departure_time" class="form-control" value="{{ old('departure_time', date('H:i')) }}" required>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="status" class="form-select" required>
                            ...
                            <option value="active" {{ old('status') === 'active' || is_null(old('status')) ? 'selected' : '' }}>Active (Checked Out)</option>
                            <option value="completed" {{ old('status') === 'completed' ? 'selected' : '' }}>Completed (Returned)</option>
                        </select>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="purpose" class="form-control" rows="3" placeholder="Reason for departure..." required>{{ old('purpose') }}</textarea>
                    </div>
                </div>

                <div class="mt-4 pt-3 border-top">
                    <button type="submit" class="btn btn-primary btn-lg px-5">Issue Gate Pass</button>
