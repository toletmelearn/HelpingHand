...
<div class="container-fluid py-4">
    ...
    <div class="mb-4">
        ...
        <h1 class="h3 d-inline-block align-middle mb-0 mt-2 mt-md-0">Book New Appointment</h1>
    </div>
    ...
    <div class="card border-0 shadow-sm bg-white">
        <div class="card-body">
            <form action="{{ route('admin.front-office.appointments.store') }}" method="POST">
                @csrf
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="visitor_name" class="form-control" placeholder="Enter parent or visitor name" value="{{ old('visitor_name') }}" required>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="status" class="form-select" required>
                            <option value="pending" {{ old('status') === 'pending' || is_null(old('status')) ? 'selected' : '' }}>Pending Approval</option>
                            <option value="approved" {{ old('status') === 'approved' ? 'selected' : '' }}>Approved / Confirmed</option>
                        </select>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" name="purpose" class="form-control" placeholder="e.g. Fees clarification, academic progress review" value="{{ old('purpose') }}" required>
                    </div>

                    <!-- Discussion Brief / Feedback -->
                    <div class="col-12">
                        <label class="form-label fw-bold">Internal Receptionist Notes</label>
                        <textarea name="feedback" class="form-control" rows="3" placeholder="Add specific notes, parent credentials details, or prior context...">{{ old('feedback') }}</textarea>
                    </div>
                </div>

                <div class="mt-4 pt-3 border-top">
                    <button type="submit" class="btn btn-primary btn-lg px-5">Book Meeting</button>
