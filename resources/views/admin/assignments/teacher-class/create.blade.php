                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="role" id="role" class="form-control @error('role') is-invalid @enderror" required>
                                        ...
                                        <option value="subject_teacher" {{ old('role') == 'subject_teacher' ? 'selected' : '' }}>Subject Teacher</option>
                                        <option value="assistant_teacher" {{ old('role') == 'assistant_teacher' ? 'selected' : '' }}>Assistant Teacher</option>
                                    </select>
                                    @error('role')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
