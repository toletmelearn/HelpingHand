...
@section('title', 'Create Document Format')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Create New Document Format</h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.document-formats.store') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="type" id="type" class="form-control @error('type') is-invalid @enderror">
                                        ...
                                        <option value="admit-card" {{ old('type') == 'admit-card' ? 'selected' : '' }}>Admit Card</option>
                                        <option value="report" {{ old('type') == 'report' ? 'selected' : '' }}>Report</option>
                                        <option value="letterhead" {{ old('type') == 'letterhead' ? 'selected' : '' }}>Letterhead</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="header_content" id="header_content" class="form-control @error('header_content') is-invalid @enderror" rows="3">{{ old('header_content') }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="footer_content" id="footer_content" class="form-control @error('footer_content') is-invalid @enderror" rows="3">{{ old('footer_content') }}</textarea>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="page_size" id="page_size" class="form-control @error('page_size') is-invalid @enderror">
                                        ...
                                        <option value="Tabloid" {{ old('page_size') == 'Tabloid' ? 'selected' : '' }}>Tabloid</option>
                                    </select>
                                    @error('page_size')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="margin_top" id="margin_top" class="form-control @error('margin_top') is-invalid @enderror" 
                                                   value="{{ old('margin_top', 10) }}" min="0" max="100" step="0.1">
                                            @error('margin_top')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="margin_bottom" id="margin_bottom" class="form-control @error('margin_bottom') is-invalid @enderror" 
                                                   value="{{ old('margin_bottom', 10) }}" min="0" max="100" step="0.1">
                                            @error('margin_bottom')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="margin_left" id="margin_left" class="form-control @error('margin_left') is-invalid @enderror" 
                                                   value="{{ old('margin_left', 10) }}" min="0" max="100" step="0.1">
                                            @error('margin_left')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="margin_right" id="margin_right" class="form-control @error('margin_right') is-invalid @enderror" 
                                                   value="{{ old('margin_right', 10) }}" min="0" max="100" step="0.1">
                                            @error('margin_right')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary">Create Document Format</button>
