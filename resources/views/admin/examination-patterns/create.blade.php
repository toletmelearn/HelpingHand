...
<div class="container">
    <div class="row">
        <div class="col-12">
            <h1 class="h3 mb-4">Create Examination Pattern</h1>
            
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Add New Examination Pattern</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.examination-patterns.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="code" id="code" class="form-control @error('code') is-invalid @enderror" value="{{ old('code') }}" required placeholder="Unique identifier (e.g., cbse_pattern)">
                                    @error('code')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea name="pattern_config" id="pattern_config" class="form-control @error('pattern_config') is-invalid @enderror" rows="10">{{ old('pattern_config') }}</textarea>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary">Create Examination Pattern</button>
                        </div>
                    </form>
                </div>
            </div>
