...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1>Edit Academic Session: {{ $academicSession->name }}</h1>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select class="form-control @error('is_current') is-invalid @enderror" 
                                ...
                                <option value="0" {{ old('is_current', $academicSession->is_current) == 0 ? 'selected' : '' }}>No</option>
                                <option value="1" {{ old('is_current', $academicSession->is_current) == 1 ? 'selected' : '' }}>Yes</option>
                            </select>
                            @error('is_current')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
