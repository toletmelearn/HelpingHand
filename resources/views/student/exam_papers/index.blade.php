        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Published Exam Papers</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm">
                                            @if($paper->file_path)
                                            <a href="{{ route('student.exam-papers.download', $paper->id) }}" 
                                               class="btn btn-primary" title="Download">
                                                <i class="fas fa-download"></i>
                                            </a>
                                            @endif
                                            <a href="{{ route('student.exam-papers.show', $paper->id) }}" 
                    ...
                    <div class="text-center py-5">
                        ...
                        <p class="text-muted">There are currently no published exam papers for your class.</p>
                    </div>
                    @endif
                </div>
                <!-- /.card-body -->
