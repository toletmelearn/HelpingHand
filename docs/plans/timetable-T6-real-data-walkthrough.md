...
**Not fixed in this session** -- flagging for a dedicated follow-up, since protecting CT reservations from backtracking touches the same mechanism T4a's own backtracking guarantees rely on and deserves its own consideration rather than a rushed patch.
