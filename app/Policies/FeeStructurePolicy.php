...
class FeeStructurePolicy
{
    ...
    {
        return $user->hasPermission('view-fee-structures') || $user->hasRole('admin');
    }
    ...
    {
        return $user->hasPermission('create-fee-structures') || $user->hasRole('admin');
    }
    ...
    {
        return $user->hasPermission('edit-fee-structures') || $user->hasRole('admin');
    }
    ...
    {
        return $user->hasPermission('delete-fee-structures') || $user->hasRole('admin');
    }
