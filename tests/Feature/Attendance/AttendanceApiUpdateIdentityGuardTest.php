...
class AttendanceApiUpdateIdentityGuardTest extends TestCase
{
    ...
    public function test_api_update_does_not_change_student_id_when_payload_contains_student_id()
    {
        $authUser = $this->createUser('auth-user@example.test');
        $originalStudentId = $this->createStudent('Original Student', '10A');
        $spoofedStudentId = $this->createStudent('Spoofed Student', '10B');
        ...
        $this->assertSame($originalStudentId, $attendance->student_id);
        $this->assertSame('absent', $attendance->status);
    }

    public function test_api_update_does_not_change_legacy_class_when_payload_contains_class()
    {
        $authUser = $this->createUser('auth-user@example.test');
    ...
    public function test_api_update_still_cannot_change_marked_by()
    {
